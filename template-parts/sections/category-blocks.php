...
<div class="gn-category-blocks">
    <div class="gn-grid gn-grid-2">
        ...
        foreach ($categories_to_render as $cat_id) : 
            ...
            // Mengambil 4 pos per kategori (1 utama, 3 list sub)
            ...
            <section class="gn-section gn-category-block">
                <header class="gn-section__header-premium">
                    <div class="gn-section__title-wrapper">
                        <span class="gn-section__accent-tag"><?php esc_html_e('KATEGORI', 'gesahan-news-pro'); ?></span>
                        <h2 class="gn-section__title-premium"><?php echo esc_html($cat_data->name); ?></h2>
                    </div>
                ...
                <div class="gn-category-block__content">
                    ...
                    <div class="gn-category-block__list">
                        ...
                        while ($query->have_posts()) : 
                            ...
                            Gesahan_Query_Tracker::track(get_the_ID());
                        ?>
                            <article class="gn-category-block__mini-card">
                                <div class="gn-category-block__mini-body">
                                    <h4 class="gn-category-block__mini-title">
                                        <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                    </h4>
                                    <span class="gn-category-block__mini-date"><?php echo esc_html(get_the_date()); ?></span>
                                </div>
                            </article>
                        <?php 
                        endwhile; 
